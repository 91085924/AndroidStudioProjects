...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ImageView imageMinus = findViewById(R.id.imageViewMinus_sign);
        ImageView imagePlus = findViewById(R.id.imageViewPlus_sign);
    ...
    public void onClick(View v)
    {
        ...
        else if(v.getId() == R.id.imageViewMinus_sign)
        {
            operation = '-';
        }
        else if(v.getId() == R.id.imageViewPlus_sign)
        {
            operation = '+';
        }
